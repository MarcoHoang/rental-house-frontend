...
const authService = {
  ...
  getCurrentUser: async () => {
    try {
      ...
      if (response.data.data) {
        ...
        console.error(
          "authService.getCurrentUser - Unknown response format:",
          response.data
        );
      ...
      if (!userData.id) {
        console.error(
          "authService.getCurrentUser - User data missing ID:",
          userData
        );
      ...
      console.log(
        "authService.getCurrentUser - Storing user data in localStorage:",
        userData
      );
  ...
  login: async (email, password) => {
    try {
      ...
      if (response.data.data) {
        ...
        console.log(
          "authService.login - Unknown response format:",
          response.data
        );
        throw new Error("Format response không được hỗ trợ");
      }
      ...
      if (!user) {
        console.log(
          "authService.login - No user data in response, fetching user profile..."
        );
        try {
          ...
          throw new Error(
            "Không thể lấy thông tin user từ server. Vui lòng thử lại."
          );
        }
      }
      ...
      // Lưu user data
      console.log(
        "authService.login - Storing user data in localStorage:",
        user
      );
  ...
  uploadAvatar: async (file) => {
    try {
      ...
      console.log(
        "authService.uploadAvatar - AUTH_CONFIG.ENABLE_AUTH:",
      ...
      console.log(
        "authService.uploadAvatar - Starting avatar upload for file:",
        file.name,
        "Size:",
        file.size
      );
      ...
      if (response.data.data) {
        ...
        console.error(
          "authService.uploadAvatar - Unknown response format:",
          response.data
        );
      ...
      console.error(
        "authService.uploadAvatar - Error response:",
        error.response
      );
      console.error(
  ...
  updateProfile: async (userId, userData) => {
    try {
      ...
      console.log(
        "authService.updateProfile - Starting update for user:",
        userId
      );
      ...
      console.log(
        "authService.updateProfile - Profile data to send:",
        profileData
      );
      ...
      console.log(
        "authService.updateProfile - Updated user data:",
        updatedUser
      );
      ...
      if (updatedUser) {
        ...
        console.log(
          "authService.updateProfile - User data saved to localStorage"
        );
      }
      ...
      console.error(
        "authService.updateProfile - Error response:",
        error.response
      );
