...
import { XMarkIcon, DocumentTextIcon, PhotoIcon, MapPinIcon, CalendarIcon } from '@heroicons/react/24/outline';
...
const HostRegistrationForm = ({ isOpen, onClose, onSubmit }) => {
  ...
  const handleChange = (e) => {
    ...
    if ((name === 'idFrontPhoto' || name === 'idBackPhoto') && files && files.length > 0) {
      const file = files[0];
      setFormData(prev => ({
        ...prev,
        [name]: file
    ...
    <ModalOverlay onClick={(e) => e.target === e.currentTarget && onClose()}>
      <ModalContent onClick={(e) => e.stopPropagation()}>
        ...
        <Form onSubmit={handleSubmit}>
          <FormGroup>
            <Label htmlFor="idNumber">Số căn cước công dân/CMT <span>*</span></Label>
            <InputWrapper>
              <InputIcon>
          ...
          <FormGroup>
            <Label htmlFor="address">Địa chỉ thường trú <span>*</span></Label>
            <InputWrapper>
              <InputIcon>
