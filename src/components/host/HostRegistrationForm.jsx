...
import { XMarkIcon, DocumentTextIcon, PhotoIcon, MapPinIcon, CalendarIcon, UserIcon, PhoneIcon, EnvelopeIcon } from '@heroicons/react/24/outline';
...
const HostRegistrationForm = ({ isOpen, onClose, onSubmit }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.proofOfOwnership) {
      newErrors.proofOfOwnership = 'Vui lòng tải lên giấy tờ chứng minh quyền sở hữu';
      isValid = false;
    }
  ...
  const handleChange = (e) => {
    ...
    if ((name === 'idFrontPhoto' || name === 'idBackPhoto' || name === 'proofOfOwnership') && files && files.length > 0) {
      const file = files[0];
      setFormData(prev => ({
        ...prev,
        [name]: file
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append('username', userProfile.fullName || userProfile.username || userProfile.email);
      ...
      console.log('FormData being sent:', {
        ...
        username: userProfile.fullName || userProfile.username || userProfile.email,
    ...
    <ModalOverlay onClick={(e) => e.target === e.currentTarget && onClose()}>
      <ModalContent onClick={(e) => e.stopPropagation()}>
        ...
        <Form onSubmit={handleSubmit}>
            ...
            <div style={{ 
              ...
              <div style={{ display: 'grid', gap: '0.5rem', fontSize: '0.875rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  ...
                  <span style={{ fontWeight: '500', color: '#374151' }}>Họ tên:</span>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <EnvelopeIcon className="w-4 h-4" style={{ color: '#6b7280' }} />
                ...
                {userProfile.address && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <MapPinIcon className="w-4 h-4" style={{ color: '#6b7280' }} />
                    <span style={{ fontWeight: '500', color: '#374151' }}>Địa chỉ:</span>
                    <span style={{ color: '#6b7280' }}>{userProfile.address}</span>
                  </div>
                )}
              </div>
          ...
          <FormGroup>
            <Label htmlFor="nationalId">Số căn cước công dân/CMT <span>*</span></Label>
            <InputWrapper>
              <InputIcon>
          ...
          <FormGroup>
            ...
            />
            {errors.idFrontPhoto && <ErrorText>{errors.idFrontPhoto}</ErrorText>}
              ...
              <FilePreview>
                ...
                <div style={{ marginTop: '8px' }}>
                  <img 
                    ...
                    style={{ maxWidth: '100%', maxHeight: '200px', border: '1px solid #e5e7eb', borderRadius: '4px' }} 
                  />
                </div>
              </FilePreview>
            )}
          ...
          <FormGroup>
            ...
            />
            {errors.proofOfOwnership && <ErrorText>{errors.proofOfOwnership}</ErrorText>}
